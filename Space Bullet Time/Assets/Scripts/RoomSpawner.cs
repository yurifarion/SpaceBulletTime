	...
	void SpawnRoom(){
		if(spawned == false){
			...
			if(openingDirection == 1){
				...
				room.GetComponent<RoomManager>().upRoom = room;
			}
			//Spawn a Up door
				...
				room.GetComponent<RoomManager>().downRoom = room;
			}
			//Spawn a Left door
				...
				room.GetComponent<RoomManager>().rightRoom = room;
			}
			//Spawn a Right door
				...
				room.GetComponent<RoomManager>().leftRoom = room;
			}
			spawned = true;
		}
	}
